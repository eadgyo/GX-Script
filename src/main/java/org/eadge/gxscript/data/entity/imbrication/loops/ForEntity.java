package org.eadge.gxscript.data.entity.imbrication.loops;
...
public class ForEntity extends DefaultStartImbricationEntity
{
    ...
    public ForEntity()
    {
        ...
        addOutputImbricatedEntry(0, DO_INPUT_INDEX, "Do", Void.class);
        addOutputImbricatedEntry(0, INDEX_FOR_OUTPUT_INDEX, "Index", Integer.class);
