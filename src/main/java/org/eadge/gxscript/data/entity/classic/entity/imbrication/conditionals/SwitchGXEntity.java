package org.eadge.gxscript.data.entity.classic.entity.imbrication.conditionals;
 ...
 *
 * Switch GXEntity block
 * Always let one entry unoccupied to let the user add new case
 */
public class SwitchGXEntity extends DefaultStartImbricationGXEntity
{
