 ...
 */
public abstract class Collection2Entity extends DefaultVariableEntity implements Class2Items
{
    ...
    public Collection2Entity(String name, Class collectionClass, Class defaultClass)
    {
        super(name);
        ...
        // Add outputs
        addOutputEntry(COLLECTION_OUTPUT_INDEX, "Collection2Entity", collectionClass);
